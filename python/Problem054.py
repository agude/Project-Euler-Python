...
The file contains one-thousand random hands dealt to two players. Each line of
...
if __name__ == '__main__':
    ...
    # comparison operators that tell us if a hand beats another. Given these,
    # it is a simple matter to loop over the hands and compare them.
    answer = 0
    for (player1_input, player2_input) in HANDS:
        player1_hand = PokerHand([PlayingCard(card) for card in player1_input])
